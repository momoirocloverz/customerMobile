            ...
            <ul class="pl15 pt10 pr15 fs14">
                ...
                <li class="pb8">
                    ...
                    <van-radio-group class="" v-model="setForm.manager">
                        ...
                        <van-radio name="1">{{setForm.managerName? setForm.managerName : '自定义'}}</van-radio>
                    </van-radio-group>
                    <!--<div v-show="setForm.manager == '1'"  class="btn-box">-->
                        <!--<span v-show="!setForm.managerName">请选择班务经理</span>-->
                        <!--<span v-show="setForm.managerName">已选:{{setForm.managerName}}</span>-->
                    <!--</div>-->
                    <!--<div v-show="setForm.manager == '1' && setForm.managerName" class="tcenter pl30 pr30 pt5">已选:{{setForm.managerName}}</div>-->
                </li>
                <li class="pb8">
                    ...
                    <van-radio-group class="" v-model="setForm.status">
                        ...
                        <van-radio name="4">{{setForm.classTaskName? `已选:${setForm.classTaskName}等${setForm.len}个班务` : '自定义'}}</van-radio>
                    </van-radio-group>
                    <!--<div v-show="setForm.status == '4'" class="btn-box">-->
                        <!--<span v-show="!setForm.classTaskName">请选择班务</span>-->
                        <!--<span v-show="setForm.classTaskName">-->
                            <!--已选:{{setForm.classTaskName}}等{{setForm.len}}个班务-->
                        <!--</span>-->
                    <!--</div>-->
                    <!--<div v-show="setForm.status == '4' && setForm.classTaskName" class="tcenter pl30 pr30 pt5">已选:{{setForm.classTaskName}}等{{setForm.len}}个班务</div>-->
                </li>
            </ul>
    ...
    export default {
        ...
        watch: {
            ...
            'setForm.date': function (val, old) {
                if(val=='1'){
                    ...
                    this.setForm.startDate = moment(new Date()).subtract('days', 6).format('YYYY-MM-DD');
                    this.handleOk();
                }else if(val=='2'){
                    this.setForm.endDate = moment(new Date()).format('YYYY-MM-DD');
                    this.setForm.startDate = moment(new Date()).subtract('days', 29).format('YYYY-MM-DD');
                    this.handleOk();
            ...
            'setForm.year': function (val, old) {
                if(val == '1'){
                    ...
                    this.setForm.endDate = moment(new Date()).format('YYYY-MM-DD');
                    this.handleOk();
                    console.log(this.setForm.startDate)
                }else if(val == '2'){
                    this.setForm.startDate = '';
                    this.setForm.startM = '';
                    this.setForm.endM = '';
        ...
        methods: {
            ...
            handleOk(){
                ...
                // //发给图表页面兄弟组件用的
                // Bus.$emit('send',{show: false,ok:true,...this.setForm})
                // //记住设置的属性，下次进如果是同一人就取这些属性展示
                // this.SET_EFI({show: false,ok:true,...this.setForm})
