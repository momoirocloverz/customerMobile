<template>
    <div class="profit-wrap-detail">
        ...
        <div class="content">
            <div class="pt10 pl20 co-orange">{{`${$route.query.startDate}~ ${$route.query.endDate}`}}</div>
            <div class="detail-item">
                ...
                <ul class=" fs14">
                    ...
                    <li class=""><span class="">合计</span>
                        <span class="co-orange">{{tableData.incomeTotal.toFixed(2)}}</span></li>
                </ul>
            </div>
            <div class="detail-item">
                <div class="pb10 fs14"><strong><img src="../../assets/img/307-2.png" class="pr5" alt="">支出</strong>
                </div>
                <ul class="fs14 ">
            ...
            <div class="detail-item">
                <div class="fs14 pb10"><strong><img src="../../assets/img/307-3.png" class="pr5" alt="">利润</strong>
                </div>
                <ul class="fs14 ">
                    <li class=""><span>事项</span>
                        <span>金额(元)</span></li>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.title = `利润明细 ${this.$route.query.managerName ? this.$route.query.managerName : ''}`;
            this.getData();
        },
        methods: {
            ...mapMutations(['IS_SET']),
            ...
            getData() {
                ...
                this.$api.getProfitDetailByManagerId(params).then(res => {
                    if (res.data.respCode == 0) {
                        ...
                        if(this.tableData.incomeList && this.tableData.incomeList.length > 0){
                            for (let item of this.tableData.incomeList) {
                                this.tableData.incomeTotal += Number(item.inCome)
                            }
                        }
                        if(this.tableData.expendList && this.tableData.expendList.length > 0){
